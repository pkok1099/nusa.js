...
Dokumentasi lengkap tersedia dalam format berikut:

- 📄 **[NUSANTARA_Dokumentasi_v0.7.4.docx](https://github.com/pkok1099/nusa.js/raw/main/docs/NUSANTARA_Dokumentasi_v0.7.4.docx)** — Dokumentasi lengkap dengan cover, TOC, dan API reference
- 📋 **[rules.md](./rules.md)** — Development rules dan guidelines
- 📁 **[docs/](./docs/)** — Folder dokumentasi tambahan
...
js/
  ...
  draw-game.js      — Semua rendering (1772 baris)
  player.js         — Player, movement, combat (1277 baris)
  boss.js           — Boss AI, attacks, phases (618 baris)
  enemy.js          — Enemy AI untuk 10 tipe (508 baris)
  entities.js       — Entity factory (339 baris)
  level.js          — Level generation per stage (373 baris)
  physics.js        — Collision detection (68 baris)
  camera.js         — Camera follow system (18 baris)
  config.js         — Constants, equipment, stages (282 baris)
  input.js          — Keyboard/mouse input (45 baris)
  inventory.js      — Inventory, equipment, buffs (302 baris)
  save.js           — Save/load localStorage (89 baris)
  shop.js           — Shop system (132 baris)
  puzzle.js         — Puzzle minigame (75 baris)
  dialog.js         — Dialog system (49 baris)
  particles.js      — Particles, floating text (109 baris)
  renderer.js       — Drawing primitives (47 baris)
  audio.js          — Web Audio sound effects (113 baris)
```
